...
module.exports = "<div class=\"ng-footer\">\r\n    <div>2019@ Nilav Patel. Made with <span class=\"color-red\">❤</span></div>\r\n</div>"
...
module.exports = "<app-header (toggleMenubar)=\"toggleMenu()\"></app-header>\r\n<div class=\"ng-content\" [ngClass]=\"{'hidden-menu-content': !isMobileResolution && !isMenuVisible}\">\r\n  <p-sidebar #menubar [visible]=\"isMenuVisible\" position=\"left\" [showCloseIcon]=\"false\" styleClass=\"ng-menubar\" [modal]=\"false\">\r\n    <app-menu (closeClicked)=\"isMobileResolution && isMenuVisible=$event\" [items]=\"menuItems\" className=\"np-menu\"></app-menu>\r\n  </p-sidebar>\r\n  <router-outlet></router-outlet>\r\n</div>\r\n<app-footer></app-footer>"
...
/* harmony import */ var _app_ngprime_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app.ngprime.module */ "./src/app/app.ngprime.module.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _core_validators_custom_min_validator_directive__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core/validators/custom-min-validator.directive */ "./src/app/core/validators/custom-min-validator.directive.ts");
/* harmony import */ var _core_validators_custom_max_validator_directive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./core/validators/custom-max-validator.directive */ "./src/app/core/validators/custom-max-validator.directive.ts");
...
var AppCommonModule = /** @class */ (function () {
    ...
    AppCommonModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [],
            exports: [
                _app_ngprime_module__WEBPACK_IMPORTED_MODULE_1__["NgPrimeModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"]
            ],
            declarations: [
                _core_validators_custom_min_validator_directive__WEBPACK_IMPORTED_MODULE_3__["CustomMinDirective"],
                _core_validators_custom_max_validator_directive__WEBPACK_IMPORTED_MODULE_4__["CustomMaxDirective"]
            ]
        })
    ], AppCommonModule);
...
var AppComponent = /** @class */ (function () {
    function AppComponent(loaderService, themeService, sessionService, translate) {
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_core_services_loader_service__WEBPACK_IMPORTED_MODULE_1__["LoaderService"],
            _core_services_theme_service__WEBPACK_IMPORTED_MODULE_2__["ThemeService"],
            _core_services_session_service__WEBPACK_IMPORTED_MODULE_3__["SessionService"],
...
/* harmony import */ var _core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./core/gaurds/auth.gaurd */ "./src/app/core/gaurds/auth.gaurd.ts");
...
/* harmony import */ var _layout_menu_menu_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./layout/menu/menu.component */ "./src/app/layout/menu/menu.component.ts");
...
/* harmony import */ var _core_services_loader_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./core/services/loader.service */ "./src/app/core/services/loader.service.ts");
...
/* harmony import */ var _core_services_route_state_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./core/services/route-state.service */ "./src/app/core/services/route-state.service.ts");
/* harmony import */ var _core_services_session_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./core/services/session.service */ "./src/app/core/services/session.service.ts");
/* harmony import */ var angular_user_idle__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! angular-user-idle */ "./node_modules/angular-user-idle/fesm5/angular-user-idle.js");
/* harmony import */ var _core_services_theme_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./core/services/theme.service */ "./src/app/core/services/theme.service.ts");
/* harmony import */ var _core_services_application_state_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./core/services/application-state.service */ "./src/app/core/services/application-state.service.ts");
/* harmony import */ var _core_services_user_data_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./core/services/user-data.service */ "./src/app/core/services/user-data.service.ts");
/* harmony import */ var _core_services_menu_data_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./core/services/menu-data.service */ "./src/app/core/services/menu-data.service.ts");
/* harmony import */ var _employees_employee_data_service__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./employees/employee-data.service */ "./src/app/employees/employee-data.service.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _core_services_user_context_service__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./core/services/user-context.service */ "./src/app/core/services/user-context.service.ts");
/* harmony import */ var _app_common_module__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./app.common.module */ "./src/app/app.common.module.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                ...
                angular_user_idle__WEBPACK_IMPORTED_MODULE_15__["UserIdleModule"].forRoot({ idle: 300, timeout: 1, ping: null }),
                _angular_common_http__WEBPACK_IMPORTED_MODULE_21__["HttpClientModule"],
                _app_common_module__WEBPACK_IMPORTED_MODULE_23__["AppCommonModule"],
            ...
            exports: [_ngx_translate_core__WEBPACK_IMPORTED_MODULE_24__["TranslateModule"]],
            providers: [
                primeng_api__WEBPACK_IMPORTED_MODULE_3__["MessageService"],
                _core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"],
                _core_services_loader_service__WEBPACK_IMPORTED_MODULE_11__["LoaderService"],
                _core_services_toast_service__WEBPACK_IMPORTED_MODULE_12__["ToastService"],
                _core_services_route_state_service__WEBPACK_IMPORTED_MODULE_13__["RouteStateService"],
                _core_services_session_service__WEBPACK_IMPORTED_MODULE_14__["SessionService"],
                _core_services_theme_service__WEBPACK_IMPORTED_MODULE_16__["ThemeService"],
                _core_services_application_state_service__WEBPACK_IMPORTED_MODULE_17__["ApplicationStateService"],
                _core_services_user_data_service__WEBPACK_IMPORTED_MODULE_18__["UserDataService"],
                _core_services_menu_data_service__WEBPACK_IMPORTED_MODULE_19__["MenuDataService"],
                _employees_employee_data_service__WEBPACK_IMPORTED_MODULE_20__["EmployeeDataService"],
                _core_services_user_context_service__WEBPACK_IMPORTED_MODULE_22__["UserContextService"]
            ],
            bootstrap: [
                _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]
            ]
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var primeng_inputtext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! primeng/inputtext */ "./node_modules/primeng/inputtext.js");
/* harmony import */ var primeng_inputtext__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(primeng_inputtext__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var primeng_dynamicdialog__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! primeng/dynamicdialog */ "./node_modules/primeng/dynamicdialog.js");
/* harmony import */ var primeng_dynamicdialog__WEBPACK_IMPORTED_MODULE_15___default = /*#__PURE__*/__webpack_require__.n(primeng_dynamicdialog__WEBPACK_IMPORTED_MODULE_15__);
...
var NgPrimeModule = /** @class */ (function () {
...
/* harmony import */ var _core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./core/gaurds/auth.gaurd */ "./src/app/core/gaurds/auth.gaurd.ts");
...
var appRoutes = [
    ...
    {
        path: 'register',
        loadChildren: function () { return __webpack_require__.e(/*! import() | register-user-register-user-module */ "register-user-register-user-module").then(__webpack_require__.bind(null, /*! ./register-user/register-user.module */ "./src/app/register-user/register-user.module.ts")).then(function (m) { return m.RegisterUserModule; }); }
    },
    {
        path: 'main',
        ...
        children: [{
                ...
                canActivate: [_core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
            },
            {
                path: 'departments',
                loadChildren: function () { return __webpack_require__.e(/*! import() | department-department-module */ "department-department-module").then(__webpack_require__.bind(null, /*! ./department/department.module */ "./src/app/department/department.module.ts")).then(function (m) { return m.DepartmentModule; }); },
                canActivate: [_core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
            },
            {
                path: 'employees',
                loadChildren: function () { return Promise.all(/*! import() | employees-employees-module */[__webpack_require__.e("common"), __webpack_require__.e("employees-employees-module")]).then(__webpack_require__.bind(null, /*! ./employees/employees.module */ "./src/app/employees/employees.module.ts")).then(function (m) { return m.EmployeesModule; }); },
                canActivate: [_core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
            },
            {
                path: 'aboutus',
                loadChildren: function () { return __webpack_require__.e(/*! import() | aboutus-aboutus-module */ "aboutus-aboutus-module").then(__webpack_require__.bind(null, /*! ./aboutus/aboutus.module */ "./src/app/aboutus/aboutus.module.ts")).then(function (m) { return m.AboutUsModule; }); },
                canActivate: [_core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
            },
            {
                path: 'contactus',
                loadChildren: function () { return __webpack_require__.e(/*! import() | contactus-contactus-module */ "contactus-contactus-module").then(__webpack_require__.bind(null, /*! ./contactus/contactus.module */ "./src/app/contactus/contactus.module.ts")).then(function (m) { return m.ContactUsModule; }); },
                canActivate: [_core_gaurds_auth_gaurd__WEBPACK_IMPORTED_MODULE_2__["AuthGuard"]]
            }]
    },
    {
...
/***/ "./src/app/core/gaurds/auth.gaurd.ts":
/*!*******************************************!*\
  !*** ./src/app/core/gaurds/auth.gaurd.ts ***!
  \*******************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _services_user_context_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/user-context.service */ "./src/app/core/services/user-context.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(router, userContextService) {
        this.router = router;
    ...
    AuthGuard = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"], _services_user_context_service__WEBPACK_IMPORTED_MODULE_2__["UserContextService"]])
    ], AuthGuard);
    return AuthGuard;
}());
...
var notification = /** @class */ (function () {
    function notification(message, createdOn, createdBy) {
...
/***/ "./src/app/core/models/route-state.model.ts":
/*!**************************************************!*\
  !*** ./src/app/core/models/route-state.model.ts ***!
  \**************************************************/
...
var MenuDataService = /** @class */ (function () {
    /**
     * menu data service
     */
    function MenuDataService() {
    }
    MenuDataService.prototype.getMenuList = function () {
        return [
            {
...
/*!******************************************************!*\
  !*** ./src/app/core/services/route-state.service.ts ***!
  \******************************************************/
/*! exports provided: RouteStateService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RouteStateService", function() { return RouteStateService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_route_state_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/route-state.model */ "./src/app/core/models/route-state.model.ts");
...
var RouteStateService = /** @class */ (function () {
     ...
     */
    RouteStateService.prototype.getCurrent = function () {
     ...
     * get all route data
     */
    RouteStateService.prototype.getAll = function () {
        var routeStates = this.getFromStorage();
        return routeStates;
    };
    /**
     ...
     */
    RouteStateService.prototype.add = function (title, path, data, isParent) {
        if (isParent) {
            this.removeAll();
        }
        var routeStates = this.getFromStorage();
        var routeState = new _models_route_state_model__WEBPACK_IMPORTED_MODULE_1__["RouteState"]();
     ...
     * load previous route
     */
    RouteStateService.prototype.loadPrevious = function () {
        var routeStates = this.getFromStorage();
        routeStates.pop();
        this.saveToStorage(routeStates);
     ...
     */
    RouteStateService.prototype.loadById = function (id) {
        var result = [];
        var isFound = false;
        var routeStates = this.getFromStorage();
        routeStates.forEach(function (route) {
            if (isFound) {
                return;
            }
            result.push(route);
     ...
     */
    RouteStateService.prototype.removeAll = function () {
        this.removeFromStorage();
    };
    RouteStateService.prototype.saveToStorage = function (routeStates) {
        localStorage.setItem("routeState", JSON.stringify(routeStates));
    };
    RouteStateService.prototype.getFromStorage = function () {
        var routeStates = JSON.parse(localStorage.getItem("routeState"));
        return (routeStates === undefined || routeStates === null) ? [] : routeStates;
    };
    RouteStateService.prototype.removeFromStorage = function () {
        localStorage.removeItem("routeState");
    };
    RouteStateService.prototype.navigate = function (path) {
...
var SessionService = /** @class */ (function () {
     ...
     * @param key
     */
    SessionService.prototype.removeItem = function (key) {
...
var ThemeService = /** @class */ (function () {
    function ThemeService() {
        this.theme = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"]("dark-theme");
    }
    /**
     *
     * @param value on selecting theme set theme variable globally
     */
    ThemeService.prototype.selectTheme = function (value) {
...
var ToastService = /** @class */ (function () {
     ...
     */
    ToastService.prototype.addSingle = function (severity, summary, detail) {
     ...
     */
    ToastService.prototype.addMultiple = function (messages) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
/* harmony import */ var _session_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./session.service */ "./src/app/core/services/session.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserContextService = /** @class */ (function () {
    function UserContextService(sessionService) {
        this.sessionService = sessionService;
    ...
    UserContextService.prototype.logout = function () {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_user_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/user.model */ "./src/app/core/models/user.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var UserDataService = /** @class */ (function () {
     ...
     * @param password
     */
    UserDataService.prototype.getUserByUserNameAndPassword = function (userName, password) {
        var user = null;
     ...
     * @param birthDate
     */
    UserDataService.prototype.addUser = function (userName, password, emailId, birthDate) {
...
/***/ "./src/app/core/validators/custom-max-validator.directive.ts":
/*!*******************************************************************!*\
  !*** ./src/app/core/validators/custom-max-validator.directive.ts ***!
  \*******************************************************************/
...
var CustomMaxDirective = /** @class */ (function () {
    ...
    CustomMaxDirective = CustomMaxDirective_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"])({
            ...
            providers: [{ provide: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NG_VALIDATORS"], useExisting: CustomMaxDirective_1, multi: true }]
        })
    ], CustomMaxDirective);
...
/***/ "./src/app/core/validators/custom-min-validator.directive.ts":
/*!*******************************************************************!*\
  !*** ./src/app/core/validators/custom-min-validator.directive.ts ***!
  \*******************************************************************/
...
var CustomMinDirective = /** @class */ (function () {
    ...
    CustomMinDirective = CustomMinDirective_1 = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"])({
            ...
            providers: [{ provide: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["NG_VALIDATORS"], useExisting: CustomMinDirective_1, multi: true }]
        })
    ], CustomMinDirective);
...
/***/ "./src/app/employees/employee-data.service.ts":
/*!****************************************************!*\
  !*** ./src/app/employees/employee-data.service.ts ***!
  \****************************************************/
...
var EmployeeDataService = /** @class */ (function () {
    ...
    EmployeeDataService.prototype.getEmployeeList = function () {
        return [
...
/* harmony import */ var _core_services_session_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../core/services/session.service */ "./src/app/core/services/session.service.ts");
/* harmony import */ var _core_models_notification_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../core/models/notification.model */ "./src/app/core/models/notification.model.ts");
...
/* harmony import */ var _core_services_user_context_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../core/services/user-context.service */ "./src/app/core/services/user-context.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(router, routeStateService, sessionService, userIdle, themeService, userContextService) {
        this.router = router;
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.notifications = [];
        for (var i = 1; i <= 5; i++) {
            var notificationObj = new _core_models_notification_model__WEBPACK_IMPORTED_MODULE_4__["notification"]("Message " + i, new Date(), null);
    ...
    HeaderComponent.prototype.showNotificationSidebar = function () {
        this.displayNotifications = true;
    };
    HeaderComponent.prototype.toggleMenu = function () {
        this.toggleMenubar.emit();
    };
    HeaderComponent.prototype.selectTheme = function (theme) {
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"],
            ...
            _core_services_session_service__WEBPACK_IMPORTED_MODULE_3__["SessionService"],
            angular_user_idle__WEBPACK_IMPORTED_MODULE_5__["UserIdleService"],
            _core_services_theme_service__WEBPACK_IMPORTED_MODULE_6__["ThemeService"],
            _core_services_user_context_service__WEBPACK_IMPORTED_MODULE_7__["UserContextService"]])
    ], HeaderComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _core_services_toast_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/services/toast.service */ "./src/app/core/services/toast.service.ts");
...
/* harmony import */ var _core_services_menu_data_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../core/services/menu-data.service */ "./src/app/core/services/menu-data.service.ts");
...
/* harmony import */ var _core_services_application_state_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../core/services/application-state.service */ "./src/app/core/services/application-state.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LayoutComponent = /** @class */ (function () {
    function LayoutComponent(toastService, loaderService, menuDataService, applicationStateService) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])("menubar", { static: true }),
        __metadata("design:type", primeng_sidebar__WEBPACK_IMPORTED_MODULE_4__["Sidebar"])
    ], LayoutComponent.prototype, "menubar", void 0);
    LayoutComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_core_services_toast_service__WEBPACK_IMPORTED_MODULE_1__["ToastService"],
            _core_services_loader_service__WEBPACK_IMPORTED_MODULE_2__["LoaderService"],
            _core_services_menu_data_service__WEBPACK_IMPORTED_MODULE_3__["MenuDataService"],
            _core_services_application_state_service__WEBPACK_IMPORTED_MODULE_5__["ApplicationStateService"]])
    ], LayoutComponent);
...
/* harmony import */ var _core_services_session_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../core/services/session.service */ "./src/app/core/services/session.service.ts");
...
var MenuComponent = /** @class */ (function () {
    function MenuComponent(routeStateService, sessionService, toastService) {
        this.routeStateService = routeStateService;
        this.sessionService = sessionService;
        this.toastService = toastService;
    ...
    MenuComponent.prototype.onMenuClick = function (menu) {
        ...
        setTimeout(function () {
            _this.closeClicked.emit(false);
        }, 100);
    };
    // toggle sub menu on click
    MenuComponent.prototype.toggleSubMenu = function (menu) {
    ...
    ], MenuComponent.prototype, "className", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Output"])(),
    ...
    MenuComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_core_services_route_state_service__WEBPACK_IMPORTED_MODULE_1__["RouteStateService"],
            _core_services_session_service__WEBPACK_IMPORTED_MODULE_2__["SessionService"],
...
module.exports = __webpack_require__(/*! C:\maxim\Verification-Back-Office\src\main.ts */"./src/main.ts");
