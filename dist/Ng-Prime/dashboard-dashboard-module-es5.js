...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(translate) {
        ...
        this.msgs = [];
        translate.get("WelcomeMessage").subscribe(function (text) {
            _this.msgs.push({ severity: 'success', summary: '', detail: text });
        });
    }
