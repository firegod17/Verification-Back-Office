...
let DepartmentDataService = class DepartmentDataService {
    constructor() {
        this.departments = [
...
let HeaderBreadcrumbComponent = class HeaderBreadcrumbComponent {
...
let HeaderBreadCrumbModule = class HeaderBreadCrumbModule {
};
