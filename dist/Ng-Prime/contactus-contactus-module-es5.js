...
var ContactUsMailDialogComponent = /** @class */ (function () {
    function ContactUsMailDialogComponent(ref) {
        this.ref = ref;
    }
    ContactUsMailDialogComponent.prototype.ngOnInit = function () {
    };
    ContactUsMailDialogComponent.prototype.closeDialog = function () {
        this.ref.close(true);
    };
    ...
    return ContactUsMailDialogComponent;
}());
...
var ContactusComponent = /** @class */ (function () {
    function ContactusComponent(dialogService, toastService, applicationStateService) {
    ...
    ContactusComponent.prototype.openDialogForMail = function () {
        var _this = this;
        var width = this.isMobileResolution ? '80%' : '20%';
        var ref = this.dialogService.open(_contact_us_mail_dialog_contact_us_mail_dialog_component__WEBPACK_IMPORTED_MODULE_1__["ContactUsMailDialogComponent"], {
            data: {},
            header: 'Send Mail',
            width: width
        });
        ref.onClose.subscribe(function (success) {
            if (success) {
                _this.toastService.addSingle("success", "Mail send successfully", "");
            }
        });
    };
