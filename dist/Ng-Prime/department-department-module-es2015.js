...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | department-list-department-list-module */[__webpack_require__.e("common"), __webpack_require__.e("department-list-department-list-module")]).then(__webpack_require__.bind(null, /*! ./department-list/department-list.module */ "./src/app/department/department-list/department-list.module.ts")).then(m => m.DepartmentListModule)
    },
    {
        path: 'department-detail',
        component: _department_component__WEBPACK_IMPORTED_MODULE_2__["DepartmentComponent"],
        loadChildren: () => Promise.all(/*! import() | department-detail-department-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("department-detail-department-detail-module")]).then(__webpack_require__.bind(null, /*! ./department-detail/department-detail.module */ "./src/app/department/department-detail/department-detail.module.ts")).then(m => m.DepartmentDetailModule)
    }
];
